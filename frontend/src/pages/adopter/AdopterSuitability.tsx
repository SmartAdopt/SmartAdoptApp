...
export const AdopterSuitability = () => {
  ...
  // Fetch existing adoption form from backend
  const {
    data: existingForm,
    isLoading: isFormLoading,
    error: formError,
  } = useQuery<AdoptionFormGetResponse | null>({
    queryKey: ["adoptionForm"],
    queryFn: adoptionFormService.getMyForm,
    staleTime: 1000 * 60 * 2,
  });

  // Determine survey completion from the API response
  const isSurveyCompleted = !!existingForm;
        ...
        {isFormLoading ? (
          ...
          >
            ...
            <Typography variant="body1" color="text.secondary" sx={{ ml: 2 }}>
              Cargando tu perfil de idoneidad...
            </Typography>
          </Box>
        ) : formError ? (
          <Alert severity="error" sx={{ mb: 3 }}>
            Error al cargar tu formulario de adopción. Intenta recargar la
            página.
          </Alert>
        ) : (
          <>
              ...
              >
                <Box sx={{ textAlign: "center", mb: 4 }}>
                  ...
                  >
                    ...
                    perfectamente a tu estilo de vida, te invitamos a llenar
                    este breve registro. Solo tomará unos minutos y nos ayudará
                    a encontrar el match perfecto.
                  </Typography>
              ...
              >
                <Box sx={{ textAlign: "center", mb: 4 }}>
                  ...
                  <Typography
                    ...
                    sx={{ maxWidth: 600, mx: "auto", mb: 4 }}
                  >
                    Gracias por llenar la encuesta. Nuestro sistema inteligente
                    ha registrado tus preferencias y condiciones para encontrar
            ...
            <Box sx={{ mb: 4 }}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                Basado en tu perfil, estas son las mascotas más compatibles
                contigo.
              </Typography>
              ...
              {isSurveyCompleted ? (
                ...
                >
                  ...
                  <Typography variant="body2" color="text.secondary">
                    Completa tu registro de idoneidad primero para que nuestra
                    IA pueda recomendarte las mascotas perfectas para ti.
                  </Typography>
                </Paper>
              )}
            </Box>
