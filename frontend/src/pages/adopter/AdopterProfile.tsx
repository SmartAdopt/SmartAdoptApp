      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ textAlign: "center", mb: 5 }}>
          ...
          <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 600, mx: "auto" }}>
            Para que nuestro sistema inteligente basado en IA realice un emparejamiento preciso y te muestre las mejores opciones de adopción, por favor indícanos tus preferencias y estilo de vida.
          </Typography>
        </Box>
